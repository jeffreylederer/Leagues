<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Site1.Master" AutoEventWireup="true" CodeBehind="Byes.aspx.cs" Inherits="Leagues.Reports.Byes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="rv1" runat="server" AsyncRendering="false" OnReportError="Rv1_ReportError"
        ...
        <LocalReport ReportPath="./Reports/ReportFiles/Byes.rdlc"  >
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>
