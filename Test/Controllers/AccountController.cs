...
namespace Test.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //var customuserStore = new CustomUserStore();
            //CustomUser user = await customuserStore.FindByNameAsync(model.Email);
            //if (user == null)
            //{
            ...
            //}
            //var 
            //_userManager = new CustomUserManager(customuserStore);
            //_signInManager = new CustomSignInManager(_userManager, HttpContext.GetOwinContext().Authentication);
        ...
        //    if (ModelState.IsValid)
        //    {
        //        var user = new CustomUser { UserName = model.Email, Id = model.Email };
